...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_BSLS,KC_PIPE, C_SCLN,KC_COMM,KC_USCR,        KC_EQL, KC_DOT, KC_CLN,KC_PIPE,KC_SLSH,
            _______,_______,_______,_______,       _______,_______,_______,_______
    ),
    ...
    [_ALT] = LAYOUT_all(
    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,  RU_YO,       XXXXXXX,XXXXXXX,RU_SHCH,XXXXXXX,XXXXXXX,
    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,       XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,
    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,       XXXXXXX,RU_HARD,XXXXXXX,XXXXXXX,XXXXXXX,
            _______,_______,_______,_______,       _______,_______,_______,_______
    ),
